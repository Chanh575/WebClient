...
exports.info = async(req, res, next) => {
    ...
    var gia = new Intl.NumberFormat('vi-VN', { style: 'currency', currency: 'VND' }).format(data.gia);
    data.giaVnd = gia;
    
    for(var i = 0; i < data1.length; i++){
      var gia = new Intl.NumberFormat('vi-VN', { style: 'currency', currency: 'VND' }).format(data1[i].gia);
      data1[i].giaVnd = gia;
    }
